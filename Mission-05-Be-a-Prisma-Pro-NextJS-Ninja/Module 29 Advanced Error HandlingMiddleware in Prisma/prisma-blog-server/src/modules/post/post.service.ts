...
const getStats = async () => {
    // postCount, publishedPost, draftPosts, totalComments, totalViews
    return await prisma.$transaction(async (tx) => {
        const [totalPosts, publishedPosts, draftPosts, archivedPosts, totalComments, approvedComments, totalUsers, adminCount, UserCount, totalViews] =
            await Promise.all([
                await tx.post.count(),
