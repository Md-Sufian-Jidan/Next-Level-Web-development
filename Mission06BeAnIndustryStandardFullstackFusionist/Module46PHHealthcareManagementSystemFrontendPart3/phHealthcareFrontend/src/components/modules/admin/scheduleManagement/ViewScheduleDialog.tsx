                    ...
                    <div className="space-y-4 px-6 py-5">
                        ...
                        {!isLoading && !isFetching && scheduleDetails && (
                            <>
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    <div className="rounded-lg border p-4">
                                        {/* ts-expect-error doctorSchedules is not typed */}
                                        <h3 className="mb-3 text-sm font-semibold">Doctor Assignments</h3>
                                        <div className="space-y-2">
                                            {(scheduleDetails.doctorSchedules ?? []).slice(0, 10).map((item: any, index: number) => (
                                    ...
                                    <div className="rounded-lg border p-4">
                                        ...
                                        <div className="space-y-2">
                                            {/* ts-expect-error doctorSchedules is not typed */}
                                            {(scheduleDetails.appointments ?? []).slice(0, 10).map((item: any, index: number) => (
