...
import { getDefaultDashboardRoute, UserRole } from "./authRoutes";
...
export const getNavItemsByRole = (role: UserRole): NavSection[] => {
    switch (role) {
        case "SUPER_ADMIN":
        case "ADMIN":
            return [...getCommonNavItems(role), ...adminNavItems];
        case "DOCTOR":
            return [...getCommonNavItems(role), ...doctorNavItems];
        case "PATIENT":
            return [...getCommonNavItems(role), ...patientNavItems];
        default:
