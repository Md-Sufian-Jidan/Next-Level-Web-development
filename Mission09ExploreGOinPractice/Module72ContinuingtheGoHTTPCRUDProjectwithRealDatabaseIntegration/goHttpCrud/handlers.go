...
func updateUserHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = db.Db.QueryRow(context.Background(), query, updatedUser.Name, updatedUser.Age, updatedUser.Email, id).Scan(&updatedUser.Name, &updatedUser.Age, &updatedUser.Email, &updatedUser.Id)
