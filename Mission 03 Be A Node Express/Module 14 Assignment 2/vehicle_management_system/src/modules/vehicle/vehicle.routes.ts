...
router.get("/vehicles", auth("admin", "customer"), vehicleControllers.getAllVehicles);
router.get("/vehicles/:vehicleId", auth("admin", "customer"), vehicleControllers.getSingleVehicle);
